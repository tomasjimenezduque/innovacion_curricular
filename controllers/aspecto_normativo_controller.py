...
"""
aspecto_normativo_controller.py — Controller para la tabla aspecto_normativo
...
router = APIRouter(prefix="/api/aspecto_normativo", tags=["AspectoNormativo"])
