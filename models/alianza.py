...
from sqlalchemy import Integer, Date, String, ForeignKeyConstraint, ForeignKey # Añadido String y ForeignKey
...
class Alianza(Base):
    ...
    # CAMBIO AQUÍ: Mapped[str] y mapped_column(String) para que coincida con el NIT del Aliado
    aliado: Mapped[str] = mapped_column(String, primary_key=True) 
    
    # Si 'departamento' referencia a 'programa.id' y este es entero, Mapped[int] está bien
